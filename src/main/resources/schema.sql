DROP TABLE IF EXISTS museum_exhibition;
DROP TABLE IF EXISTS exhibition;
DROP TABLE IF EXISTS installation;
DROP TABLE IF EXISTS museum;

CREATE TABLE museum (
	museum_id int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE installation (
	installation_id int AUTO_INCREMENT NOT NULL,
...
CREATE TABLE museum_exhibition (
	...
	UNIQUE KEY (museum_id, exhibition_id)
);